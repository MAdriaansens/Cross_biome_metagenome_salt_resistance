...
mmseqs easy-search -e 1.00E-03 -c 0.0 --threads 20 ${Seq}/PF03814_KdpA_sequences.fasta  ${Arc_db} ${MMseqs}/PF03814_KdpAvsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03_mmseq.tsv tmp
...
#HMMsearch
hmmsearch --noali --cpu 20 -E 0.001 --tblout ${HMMsearch}/PF03814_kdphmmvs_vsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03.tsv ${HMMdir}/PF03814_kdp.hmm ${Arc_db}
...
mmseqs easy-search -e 1.00E-03 -c 0.0 --threads 20 ${Seq}/PF04069_OpuAC_sequences.fasta  ${Arc_db} ${MMseqs}/PF04069_OpuACvsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03_mmseq.tsv tmp
module load Python/3.11.3-gimkl-2022a
...
#HMMsearch
hmmsearch --noali --cpu 20 -E 0.001 --tblout ${HMMsearch}/PF04069_OpuAChmmvs_vsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03.tsv ${HMMdir}/PF04069_OpuAC.hmm ${Arc_db}
...
mmseqs easy-search -e 1.00E-03 -c 0.0 --threads 20 ${Seq}/PF04208_MtrA_sequences.fasta  ${Arc_db} ${MMseqs}/PF04208_MtrAvsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03_mmseq.tsv tmp
...
#HMMsearch
hmmsearch --noali --cpu 20 -E 0.001 --tblout ${HMMsearch}/PF04208_MtrAhmmvs_vsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03.tsv ${HMMdir}/PF04208_MtrA.hmm ${Arc_db}
...
mmseqs easy-search -e 1.00E-03 -c 0.0 --threads 20 ${Seq}/PF06339_EctC_sequences.fasta  ${Arc_db} ${MMseqs}/PF06339_EctCvsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03_mmseq.tsv tmp
...
#HMMsearch
hmmsearch --noali --cpu 20 -E 0.001 --tblout ${HMMsearch}/PF06339_EctChmmvs_vsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03.tsv ${HMMdir}/PF06339_EctC.hmm ${Arc_db}
...
mmseqs easy-search -e 1.00E-03 -c 0.0 --threads 20 ${Seq}/PF21269_TreT_sequences.fasta  ${Arc_db} ${MMseqs}/PF21269_TreTvsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03_mmseq.tsv tmp
...
#HMMsearch
hmmsearch --noali --cpu 20 -E 0.001 --tblout ${HMMsearch}/PF21269_TreThmmvs_vsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03.tsv ${HMMdir}/PF21269_TreT.hmm ${Arc_db}
...
mmseqs easy-search -e 1.00E-03 -c 0.0 --threads 20 ${Seq}/PF24836_NqrA_sequences.fasta  ${Arc_db} ${MMseqs}/PF24836_NqrAvsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03_mmseq.tsv tmp
...
#HMMsearch
hmmsearch --noali --cpu 20 -E 0.001 --tblout ${HMMsearch}/PF24836_NqrAhmmvs_vsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03.tsv ${HMMdir}/PF24836_NQRA.hmm ${Arc_db}
...
mmseqs easy-search -e 1.00E-03 -c 0.0 --threads 20 ${Seq}/PTHR47704_KimA_sequences.faa  ${Arc_db} ${MMseqs}/PTHR47704_KimAvsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03_mmseq.tsv tmp
...
#HMMsearch
hmmsearch --noali --cpu 20 -E 0.001 --tblout ${HMMsearch}/PTHR47704_KimAhmmvs_vsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03.tsv ${HMMdir}/PTHR47704_KimA.hmm ${Arc_db}
...
mmseqs easy-search -e 1.00E-03 -c 0.0 --threads 20 ${Seq}/TIGR01804.1-Betain-Aldyhde-dehydrogenase_sequences.fasta  ${Arc_db} ${MMseqs}/TIGR01804.1-Betain-Aldyhde-dehydrogenasevsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03_mmseq.tsv tmp
...
#HMMsearch
hmmsearch --noali --cpu 20 -E 0.001 --tblout ${HMMsearch}/TIGR01804.1_Betain-aldehyde-dehydrogenasehmmvs_vsArchaea_subset${array[$SLURM_ARRAY_TASK_ID]}_e03.tsv ${HMMdir}/TIGR01804.1_Betain-aldehyde-dehydrogenase.hmm ${Arc_db}
